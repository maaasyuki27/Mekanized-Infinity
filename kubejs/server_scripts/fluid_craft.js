...
EntityEvents.spawned('minecraft:item', event => {
    ...
    if(event.entity.item.id == 'mek_inf:flux_dust_block')
        attemptSetBlock(30, event.entity, 'minecraft:lava', 'mek_inf:flux_water')
    if(event.entity.item.id == 'extendedcrafting:redstone_ingot_block')
        attemptSetBlock(30, event.entity, 'mek_inf:flux_water', 'mekanism:block_raw_osmium')
    if(event.entity.item.id == 'mek_inf:bio_cube')
        attemptSetBlock(30, event.entity, 'mek_inf:flux_water', 'mek_inf:bio_juice')
    if(event.entity.item.id == 'minecraft:sugar_cane')
        attemptSetBlock(30, event.entity, 'mek_inf:bio_juice', 'minecraft:oak_sapling')
